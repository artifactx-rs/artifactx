...
| Drop-directory production publish | ✅ Shipped | | `arx publish-dir` productizes package-drop ingestion, no-op state, publish/cutover, and optional non-invasive external sync trigger. |
